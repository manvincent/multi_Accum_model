...
# -*- coding: utf-8 -*-
"""
Module: ValideModelFit_Subject.py
Author: Vincent Man, v.man@mail.utoronto.ca
Date: 2018 05 24


Description: For each subjec, generates a sample from the best fitting model parameters and compares against experimental data 
"""
